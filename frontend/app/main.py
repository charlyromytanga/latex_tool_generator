...
from frontend.app.components.widgets import (
    upload_offer_widget,
...
from frontend.app.services import RecruitmentApiClient
from frontend.app.utils_functions import AppSettings, SessionPayload
