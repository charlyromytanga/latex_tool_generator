...
\[
V_{n,i} = \frac{1}{1+r} \left[ p \, V_{n+1,i+1} + (1-p) \, V_{n+1,i} \right]
\]
...
\begin{itemize}
    ...
    \item $p = \frac{(1+r)-d}{u-d}$ : probabilité neutre au risque  
...
Voici un pseudo-code pour construire l'arbre binomial et calculer les valeurs de l'option et les deltas :
...
% Ici tu peux mettre tes captures d'écran des arbres binomial pour S et V, et des tableaux Delta
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/arbres_call.png}
    \caption{Arbre binomial du sous-jacent et valeurs de l'option (CALL)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/delta_call.png}
    \caption{Delta à chaque nœud pour le CALL}
\end{figure}
...
% Contenu des codes (captures d'écran)
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/code_call.png}
    \caption{Code Python complet pour le CALL}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/code_put.png}
    \caption{Code Python complet pour le PUT}
\end{figure}
