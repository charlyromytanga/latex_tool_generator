-- SQLite schema initialization for recruitment assistant application
...
-- Keywords extracted by LLM for matching and CV section generation
-- --------------------------------------------------------------------------
...
-- Personal experiences used for matching and CV section generation
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- TABLE: my_projects
-- Personal projects used for matching and CV section generation
-- --------------------------------------------------------------------------
